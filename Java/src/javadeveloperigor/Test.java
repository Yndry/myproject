...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        StringBuilder eachWords = new StringBuilder();
        ...
        for (; ; ) {
            ...
            //System.out.printf("Start index %d End INDEX %d%n", startIndexWord, partIndex);
           String ss= tongueTwister.substring(startIndexWord, partIndex);
ss=ss.trim();
            if(ss.length()>0) System.out.printf("Word out string %s %n", ss);
            //System.out.print(partIndex + " ");

            startIndexWord = partIndex;
        }
